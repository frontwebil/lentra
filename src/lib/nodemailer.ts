...
export async function sendPasswordRecoveryEmail(
  ...
  const recoveryUrl = `${process.env.NEXT_PUBLIC_APP_URL}/password-recovery-confirm?token=${token}`;

  const content = isEnglish
    ? {
        lang: "en",
        subject: "Reset your password - Lentra",
        title: "Reset your password",
        description:
          "We received a request to reset your Lentra account password. Click the button below to create a new password.",
    ...
    : {
        lang: "uk",
        subject: "Відновлення пароля - Lentra",
        title: "Відновіть свій пароль",
        description:
          "Ми отримали запит на відновлення пароля вашого акаунта Lentra. Натисніть кнопку нижче, щоб створити новий пароль.",
